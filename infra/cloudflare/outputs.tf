...
output "barry_tunnel_id" {
  value = cloudflare_zero_trust_tunnel_cloudflared.barry_mac.id
}

output "barry_access_service_token_id" {
  value = cloudflare_zero_trust_access_service_token.barry_machine.client_id
}

output "barry_access_service_token_secret" {
  value     = cloudflare_zero_trust_access_service_token.barry_machine.client_secret
  sensitive = true
}
