...
let package = Package(
    ...
    targets: [
        ...
        // Pure, UI-independent logic (message model, segment building, scroll
        // policy) — split out so it can be unit-tested without the executable.
        .target(
            name: "BarrySessionsCore",
            path: "Core",
            swiftSettings: [.swiftLanguageMode(.v5)]
        ...
        .testTarget(
            ...
            path: "Tests",
            sources: ["ContractDecodeTests.swift", "ChatScrollModelTests.swift"],
            swiftSettings: [.swiftLanguageMode(.v5)]
        ),
    ]
)
