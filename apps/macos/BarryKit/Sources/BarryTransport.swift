...
public struct BarryTransport: Sendable {
    ...
    public func listSessions(
        ...
        let output = try await client.listSessions(.init(query: .init(cursor: cursor, limit: limit, query: query, active: active)))
    ...
    public func listAvailablePacks() async throws -> Components.Schemas.AvailablePacksResponse {
        try await client.listAvailablePacks().ok.body.json
    }
