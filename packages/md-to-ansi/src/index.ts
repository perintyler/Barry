...
/**
 * @barry-rocks/md-to-ansi — Markdown-to-ANSI terminal renderer and TUI primitives.
 *
 * Subpath imports:
 *   - @barry-rocks/md-to-ansi/markup  — markdown-to-ANSI renderer
 *   - @barry-rocks/md-to-ansi/tui     — terminal UI primitives
 */
export * from "./markup/index.js";
export { default } from "./markup/index.js";
