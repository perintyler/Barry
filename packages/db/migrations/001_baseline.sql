...
-- DROPPED by 004_drop_artifacts.sql. Artifacts live entirely in the artifacts
-- bag's Cloudflare deployment (Durable Object SQLite + R2), which is the sole
-- source of truth; see docs/storage-boundaries.md. Kept here because an applied
-- migration is history and must not be rewritten -- do not build on this table.
