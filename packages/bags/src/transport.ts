 ...
 * bag proxy connections (both in @barry-rocks/bags and in servers/mcp).
 */

/**
 * Custom fetch that bags the GET SSE stream opened by
 ...
 * same H2 connection hang indefinitely. Bag proxies only need
