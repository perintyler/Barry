...
The provider-neutral runtime for Barry agent sessions. It owns the common session lifecycle, model catalog, event types, capability declarations, and the Claude, Codex, and OpenCode adapters.
