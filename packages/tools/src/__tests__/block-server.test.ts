...
// Mock MCP SDK before importing block-server
...
import { startBlockServer } from "../block-server.js";
...
describe("startBlockServer", () => {
  ...
  it("registers tools and connects via stdio", async () => {
    ...
    await startBlockServer({ name: "test-block", tools: [tool] });
  ...
  it("registers barry://tools-meta resource", async () => {
    ...
    await startBlockServer({ name: "weather-block", tools: [tool] });
  ...
  it("registers multiple tools with correct metadata", async () => {
    ...
    await startBlockServer({ name: "fs-block", tools });
