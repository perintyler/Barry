...
description: Create a new HTTP service in the Barry monorepo — directory layout, launchd setup, environment configuration, logging and QA. Use when adding a service under servers/, apps/web/ or a block under blocks/.
---
...
- `blocks/<name>/app/` - Native macOS apps, owned by the block whose feature they serve
- `packages/BarryKit/` - Shared Swift package for those apps
