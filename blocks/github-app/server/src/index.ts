...
import { validateEnv } from "@barry/env";
...
const app = express();
// launchd injects PORT from the port declared in block.yaml. The fallback keeps
 ...
 *
 * Read at request time from a 0600 file rather than declared in the block
