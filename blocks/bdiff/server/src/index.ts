...
// launchd injects PORT from the port declared in block.yaml. The fallback is
// only for a hand-started server; the manifest is the source of truth.
const PORT = process.env.PORT ? parseInt(process.env.PORT, 10) : 3862;
