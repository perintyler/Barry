 ...
 *
 * Usage:
 *   pnpm --filter @barry-bags/slack-app manifest              # prints YAML to stdout
 *   pnpm --filter @barry-bags/slack-app manifest -- --write    # writes to ~/.barry/slack-app-manifest.yaml
 *   pnpm --filter @barry-bags/slack-app manifest -- --push     # pushes to Slack via apps.manifest.update
 *
 * Environment:
