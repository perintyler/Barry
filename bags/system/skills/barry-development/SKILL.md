...
description: Create a new HTTP service in the Barry monorepo — directory layout, launchd setup, environment configuration, logging and QA. Use when adding a service under servers/, apps/web/ or a bag under bags/.
---
...
- `bags/<name>/app/` - Native macOS apps, owned by the bag whose feature they serve
