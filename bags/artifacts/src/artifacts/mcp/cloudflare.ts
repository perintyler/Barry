...
// Generated by scripts/build.js; typed in ../generated.d.ts rather than
// suppressed, so a change to their shape is a compile error here.
...
export function createArtifactsMcpApp(config: ArtifactsMcpAppConfig) {
  ...
  app.get("/plugin/skills/:name/SKILL.md", (c) => {
    const skill = pluginSkills[c.req.param("name")];
  ...
  app.get("/plugin", (c) => {
    ...
    return c.json({
      ...
      skills: Object.keys(pluginSkills).map((name) => ({
        name,
