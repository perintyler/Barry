...
// Shared with the browser renderer. The worker used to keep a hand-copied
// duplicate because it is TS compiled without `allowJs`; that is now enabled,
// so there is one implementation and parity.test.ts guards it staying that way.
import { parseCsv } from '../artifact-format.js';
import { highlight as syntaxHighlight, detect as detectLanguage, getLanguage } from '../../syntax/index.js';
