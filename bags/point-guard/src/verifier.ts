...
const JUDGE_DENIED_TOOLS = [
  ...
  // Closing it needs an allowlist mechanism (OPEN-LOOPS).
  "mcp__*",
];
 ...
 * non-ACCEPT verdict blocks. Brain commentary cannot change this function's
 * answer — it takes no brain input at all.
 */
