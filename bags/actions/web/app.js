...
function openTrigger(a) {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      // Awaited but not bound: the response body is unused — the run is read
      // back from history — while the await still surfaces a failed trigger
      // through api()'s throw, which the catch below turns into a toast.
