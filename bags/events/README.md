...
`packages/db/src/events.ts`, and the contract schema, the closed enum described
above, is in `packages/contracts/src/index.ts`.

See [Primitives](../../docs/primitives.md) for how events relate to the other
primitives, and [Sessions](../../docs/sessions.md) for the lifecycle they
record against.
