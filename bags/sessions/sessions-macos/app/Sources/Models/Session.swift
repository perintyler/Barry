...
/// every frame. `SessionBound` and `StatusUpdate` conform for the same reason —
...
struct Session: Codable, Identifiable, Equatable {
    ...
    var isReadOnly: Bool {
        bound?.deniedAccess?.contains("write") == true
    }
}

struct SessionBound: Codable, Equatable {
