...
struct CreateBoundSheet: View {
    ...
    private func create() async {
        isSaving = true
        errorMessage = nil
        let created = await editor.createBound(
        ...
        if created != nil {
            ...
            // createBound routes failures to the editor; surface it here rather
            // than dismissing over a bound that was never created.
            errorMessage = editor.errorMessage ?? "Could not create the bound."
        }
    }
}
