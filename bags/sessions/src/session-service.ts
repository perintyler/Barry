 ...
 * MCP Session Service.
 *
 * Now delegates to @barry-rocks/db for all core database operations.
...
export class SessionService {
   ...
   */
  async getSessionByProviderSessionId(providerSessionId: string): Promise<Session | undefined> {
  ...
  private attachTranscript(session: Session): SessionWithTranscript {
  ...
  async getMessages(
    ...
    return dbGetSessionMessages(sessionId, {
      ...
      // layer: every caller paid the full JSONB fetch. Measured at the client
